...
export const registrarPersona = async (user) => {
  try {
    const response = await fetch('http://10.224.0.5:30001/registrar/usuario', {
      method: "POST",
      headers: {
...
export const iniciarSesion = async (user) => {
  try {
    const response = await fetch('http://10.224.0.5:30001/iniciar/sesion', {
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
...
export const crearArriendo = async (arriendo) => {
  try {
    const response = await fetch('http://10.224.0.5:30001/crear/nuevo/arriendo', {
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
...
export const listarArriendos = async () => {
  try {
    const response = await fetch('http://10.224.0.5:30001/obtener/arriendo', {
      method: "GET",
    });
